...
## [Link to the GitHub Repository](https://github.com/aleksandr-efimenko/local-nextjs-postgres-s3)

### 1. Upload and download files using Next.js API routes (4MB limit)
...
##### 1.1.1 Upload form UI (the same for both approaches)
...
```js filename="src/components/UploadFilesFormUI.tsx" copy
